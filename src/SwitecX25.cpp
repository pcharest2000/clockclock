...
SwitecX25::SwitecX25(int32_t steps, unsigned char pin1, unsigned char pin2, unsigned char pin3, unsigned char pin4)
{
  this->currentState = 0;
  this->steps = steps;
  this->pins[0] = pin1;
...
void SwitecX25::advance()
{
  ...
  int32_t delta = dir>0 ? targetStep-currentStep : currentStep-targetStep;
...
void SwitecX25::setPosition(int32_t pos)
{
